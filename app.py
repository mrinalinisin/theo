...
def create_app():
    ...
    @app.context_processor
    def inject_project_url():
        # Exposed to every template so the "Generated by Theo" footer
        # on published pages can be overridden by fork operators via the
        # THEO_PROJECT_URL env var (see config.py).
        return dict(theo_project_url=app.config.get(
            "THEO_PROJECT_URL", "https://github.com/mrinalinisin/theo"
        ))
