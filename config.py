...
class Config:
    ...
    # URL printed in the "Generated by Theo" footer on every published
    # index/page. Defaults to the upstream Theo repo; fork operators can
    # point it at their own source by setting THEO_PROJECT_URL in .env.
    THEO_PROJECT_URL = os.getenv(
